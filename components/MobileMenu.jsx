                  ...
                  return (
                    ...
                    >
                      <Link
                        href={item.to}
                        onClick={onClose}
                        className={`group flex items-center justify-between border-b border-white/12 py-5 font-heading text-4xl font-light uppercase leading-none transition duration-500 hover:border-white/40 hover:text-white sm:text-6xl ${
