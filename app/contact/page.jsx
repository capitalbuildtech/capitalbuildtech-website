...
export const metadata = {
  title: 'Contact',
  description:
    'Contact Capital BuildTech Engineering for building design, engineering, construction management, site supervision, and project implementation requirements.',
};
