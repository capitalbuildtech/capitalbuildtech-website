...
export default function Services() {
  return (
    <AnimatedPage>
      <SEO
        title="Services | Capital BuildTech Engineering"
        description="Explore Capital BuildTech Engineering services including architectural design, structural design, electrical design, plumbing design, construction management, supervision, and project implementation."
      />
      <PageHero
        eyebrow="Services"
