...
export default function Projects() {
  ...
  return (
    <AnimatedPage>
      <SEO
        title="Projects | Capital BuildTech Engineering"
        description="Browse the Capital BuildTech Engineering project portfolio structure with searchable, filterable project cards ready for verified project data."
      />
      <PageHero
        eyebrow="Projects"
